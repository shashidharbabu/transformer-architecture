...
class SelfAttention(nn.Module):
    ...
    def forward(self, values, keys, query, mask):
        ...
        #Splitting embedding data into self.heads peices
        ...
        energy = torch.einsum("nqhd,nkhd -> nhqk", [queries, keys] ) #used for matrix multiplication with other dimensions
        ...
        #after einsum (N, query_len, heads, head_dim) we flatten last 2 dim
